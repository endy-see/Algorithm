...
public class QuickSort {
    ...
    public static void main(String[] args) {
        ...
        // 问题1、经典快速排序：每次选定数组的最后一个数作为参照的比较对象
        // QuickSort1(arr);

        // 问题2-1、partion的两种过程：1.　小于等于给定数的放在数组的左边部分　大于给定数的放在数组的右边部分
        // partion1(arr, 50);

        // 问题2-２、partion的令一个过程：２. 荷兰国企问题问题：小于给定数的放在数组的左边部分　等于给定数的放在数组的中间部分　大于给定数的放在数组的右边部分
        // partion2(arr, 50);

        // 问题３、用partion过程实现经典快排/随机快排
